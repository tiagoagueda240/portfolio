  ...
  return (
    ...
    >
      <motion.div
        ...
        style={{ background: useMotionTemplate`radial-gradient(300px circle at ${mouseX}px ${mouseY}px, ${cat.glowColor}, transparent 80%)` }}
      />
      ...
      <h4 className="text-base sm:text-lg font-bold text-white mb-3 tracking-tight relative z-10">{cat.titulo}</h4>
