  ...
  return (
    <div className="bg-[#030303] min-h-screen text-slate-200 font-sans relative overflow-x-hidden selection:bg-blue-500/30">
      ...
      <div className="fixed inset-0 pointer-events-none z-0">
        ...
        <motion.div className="absolute top-[-10%] left-[-10%] w-[100vw] md:w-[50vw] h-[100vw] md:h-[50vw] rounded-full bg-blue-900/10 blur-[120px]" animate={{ x: [0, 50, 0], scale: [1, 1.1, 1] }} transition={{ duration: 20, repeat: Infinity }} />
      </div>
