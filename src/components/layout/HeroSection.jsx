  ...
  return (
    ...
    >
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 items-center w-full">
        ...
        >
          ...
          >
            ...
            <motion.div
              ...
              className="flex flex-col sm:flex-row gap-4 mt-4 w-full sm:w-auto justify-center lg:justify-start"
            >
              <MagneticButton
                href="#projetos"
                className="group relative px-8 py-4 bg-white text-slate-950 font-black uppercase tracking-widest text-sm rounded-full overflow-hidden transition-transform w-full sm:w-auto text-center"
              >
        ...
        <motion.div
          style={{ y: heroPhotoY }}
          className="lg:col-span-5 relative w-full flex justify-center lg:justify-end order-1 lg:order-2"
        >
          <motion.div
